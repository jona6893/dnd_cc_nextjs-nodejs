...
function Startscreen() {
  ...
  return (
    <section className="w-screen h-screen inset-0 fixed md:bg-background/50 backdrop-blur-sm max-md:bg-overlay flex items-center overflow-auto justify-center text-white z-50">
      <div className="relative md:w-10/12 md:h-5/6 max-md:w-full max-w-7xl max-md:h-full grid md:grid-cols-2 gap-4 bg-overlay rounded-2xl p-4 border border-gray-50">
